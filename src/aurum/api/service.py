...
# NOTE: Curve query functions migrated to curves_service.py for service decomposition
...
# NOTE: Admin cache invalidation functions migrated to admin_service.py
...
# NOTE: Curve cache invalidation function migrated to curves_service.py
