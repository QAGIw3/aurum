...
try:  # Dataset scheduling
    ...
    DATASET_SCHEDULE = [
        Dataset(iso_trigger("spp", "load_window_ready")),
        Dataset(iso_trigger("spp", "genmix_window_ready")),
    ]
...
with DAG(
    ...
    try:
        if Dataset is not None:
            ...
            load_watermark.outlets = [Dataset(iso_ingest("spp", "load"))]  # type: ignore[attr-defined]
            genmix_watermark.outlets = [Dataset(iso_ingest("spp", "genmix"))]  # type: ignore[attr-defined]
    except Exception:
        pass
